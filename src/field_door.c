...
static const u8 sDoorAnimTiles_Dewford_Dam[] = INCBIN_U8("graphics/door_anims/dewford_dam.4bpp");
...
static const u8 sDoorAnimPalettes_Littleroot[] = {9, 9, 8, 8, 8, 8, 8, 8};
...
static const u8 sDoorAnimPalettes_Dewford_Dam[] = {6, 6, 6, 6, 6, 6, 6, 6};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Dewford_Door_Dam,                                 DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_Dewford_Dam, sDoorAnimPalettes_Dewford_Dam},
