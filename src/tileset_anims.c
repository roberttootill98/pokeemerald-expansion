...
static void QueueAnimTiles_General_Water_Curved(u16);
...
const u16 gTilesetAnims_General_Water_Curved_Frame0[] = INCBIN_U16("data/tilesets/primary/general/anim/water_curved/0.4bpp");
const u16 gTilesetAnims_General_Water_Curved_Frame1[] = INCBIN_U16("data/tilesets/primary/general/anim/water_curved/1.4bpp");
const u16 gTilesetAnims_General_Water_Curved_Frame2[] = INCBIN_U16("data/tilesets/primary/general/anim/water_curved/2.4bpp");
const u16 gTilesetAnims_General_Water_Curved_Frame3[] = INCBIN_U16("data/tilesets/primary/general/anim/water_curved/3.4bpp");
const u16 gTilesetAnims_General_Water_Curved_Frame4[] = INCBIN_U16("data/tilesets/primary/general/anim/water_curved/4.4bpp");
const u16 gTilesetAnims_General_Water_Curved_Frame5[] = INCBIN_U16("data/tilesets/primary/general/anim/water_curved/5.4bpp");
const u16 gTilesetAnims_General_Water_Curved_Frame6[] = INCBIN_U16("data/tilesets/primary/general/anim/water_curved/6.4bpp");
const u16 gTilesetAnims_General_Water_Curved_Frame7[] = INCBIN_U16("data/tilesets/primary/general/anim/water_curved/7.4bpp");

const u16 *const gTilesetAnims_General_Water_Curved[] = {
    gTilesetAnims_General_Water_Curved_Frame0,
    gTilesetAnims_General_Water_Curved_Frame1,
    gTilesetAnims_General_Water_Curved_Frame2,
    gTilesetAnims_General_Water_Curved_Frame3,
    gTilesetAnims_General_Water_Curved_Frame4,
    gTilesetAnims_General_Water_Curved_Frame5,
    gTilesetAnims_General_Water_Curved_Frame6,
    gTilesetAnims_General_Water_Curved_Frame7
};
...
const u16 gTilesetAnims_General_SandWaterEdge_Frame7[] = INCBIN_U16("data/tilesets/primary/general/anim/sand_water_edge/7.4bpp");
...
static void TilesetAnim_General(u16 timer)
{
    ...
    if (timer % 16 == 2)
        QueueAnimTiles_General_Water_Curved(timer >> 4);
    if (timer % 16 == 3)
...
static void QueueAnimTiles_General_Water_Curved(u16 timer)
{
    u8 i = timer % 8;
    AppendTilesetAnimToBuffer(gTilesetAnims_General_Water_Curved[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(356)), 0x180);
}
