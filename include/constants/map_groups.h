...
#define MAP_SUNDARA_VILLAGE_CONTEST_HALL         (5 | (1 << 8))
#define MAP_SUNDARA_VILLAGE_RIVALS_HOUSE         (6 | (1 << 8))
#define MAP_SUNDARA_VILLAGE_HOUSE                (7 | (1 << 8))
...
#define MAP_SHARD_MINES_ENTRANCE                    (9 | (6 << 8))
...
// static const u8 MAP_GROUP_COUNT[] = {57, 8, 5, 6, 7, 8, 10, 7, 7, 14, 8, 17, 10, 23, 13, 15, 15, 2, 2, 2, 3, 1, 1, 1, 108, 61, 89, 2, 1, 13, 1, 1, 3, 1, 0};
