...
// venarus cove
#define FLAG_VENARUSCOVE_FISHERMANSCLUB_QUIZ_COMPLETE                   (NEW_FLAGS_START + 0xD)
#define FLAG_VENARUSCOVE_GOT_FISHERMANS_BADGE                           (NEW_FLAGS_START + 0xE) 
#define FLAG_VENARUSCOVE_BLOCKING_FISHERMAN_STARTING_PLACE              (NEW_FLAGS_START + 0xF)
#define FLAG_VENARUSCOVE_BLOCKING_FISHERMAN_NEW_PLACE                   (NEW_FLAGS_START + 0x10)
#define FLAG_ITEM_VENARUSCOVE_PARALYZEHEAL                              (NEW_FLAGS_START + 0x11)
